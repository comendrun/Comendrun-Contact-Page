        ...
        <div className="container-max section-padding">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ...
              modern technologies. Specialized in full-stack development with a
        ...
        <div className="container-max section-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              the privilege of working with diverse teams and technologies to
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Started as a junior developer with a passion for clean code and
                elegant solutions. Over the years, I&apos;ve evolved into a senior
                developer who thrives on solving complex problems and mentoring
                upcoming talent.
              </p>
              <p className="text-gray-600">
                I believe in continuous learning and staying updated with the
                latest industry trends. My approach combines technical expertise
                with strong communication skills to deliver projects that exceed
                expectations.
              </p>
            </div>
